...
public interface GoodsCategoryMapper extends BaseMapper<GoodsCategory> {
    ...
    List<GoodsCategoryDO> getGoodsCategoryByName(@Param("categoryType") String categoryType);

    /**
     * 根据父分类名称模糊查询货物分类
     */
    @Select("SELECT * FROM goods_category WHERE category_parent_type LIKE CONCAT('%', #{categoryParentType}, '%')")
    List<GoodsCategoryDO> getGoodsCategoryByParentName(@Param("categoryParentType") String categoryParentType);
    ...
    List<GoodsCategoryDO> getGoodsCategoryByNameAndParentName(@Param("categoryType") String categoryType, @Param("categoryParentType") String categoryParentType);
    ...
    List<GoodsCategoryDO> getAllGoodsCategory();
